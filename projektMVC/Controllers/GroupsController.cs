    ...
    public class GroupsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Groups != null ? 
                          ...
                          Problem("Entity set 'CoreStudentsContext.Groups'  is null.");
        }

        // GET: Groups with Students
        //[Route]
        public async Task<IActionResult> IndexWithStudents()
        {
            UZView uzview = new UZView()
            {
        ...
        public async Task<IActionResult> Create([Bind("GrupaId,Nazwa")] Group @group)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GrupaId,Nazwa")] Group @group)
        {
            if (id != @group.GrupaId)
            {
                return NotFound();
